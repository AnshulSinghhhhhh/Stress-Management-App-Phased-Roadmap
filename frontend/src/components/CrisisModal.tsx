    ...
    >
      <div className="w-full max-w-xl bg-surfaceLowest border border-outline-variant rounded-3xl p-6 sm:p-8 shadow-modal relative flex flex-col space-y-6">
        ...
        <div className="flex items-start space-x-4 pt-1">
          <div className="w-12 h-12 rounded-full bg-terracotta-container flex items-center justify-center text-terracotta flex-shrink-0 shadow-sm">
            <HeartHandshake className="w-6 h-6" />
          </div>
          <div className="space-y-1">
            <div className="inline-flex items-center space-x-1.5 px-3 py-0.5 rounded-full bg-terracotta-container/60 text-terracotta font-medium text-xs">
              <Shield className="w-3.5 h-3.5" />
              <span>Confidential &amp; 24/7 Human Care</span>
            </div>
            <h2
              id="crisis-modal-title"
              className="font-headline text-2xl font-medium text-on-surface tracking-tight"
            >
              {data.copy?.headline || 'You are not alone. Support is here for you.'}
            </h2>
            <p
              id="crisis-modal-desc"
              className="text-sm text-on-surface-variant leading-relaxed pt-1"
            >
              {data.copy?.message ||
                'If you are feeling overwhelmed, safe, compassionate professionals are ready to listen right now.'}
            </p>
          </div>
        </div>
            ...
            >
              <div className="space-y-1 pr-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs px-2 py-0.5 rounded-full bg-surfaceLowest text-outline font-medium border border-outline-variant">
                    {resource.provider}
                  </span>
                </div>
              ...
              <a
                ...
                className="inline-flex items-center justify-center space-x-2 px-5 py-2.5 rounded-full bg-terracotta text-white font-medium text-sm hover:bg-terracotta-dark shadow-sm active:scale-95 transition-all flex-shrink-0"
              >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-2 border-t border-outline-variant/60 gap-3">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 rounded-full bg-surface-container text-on-surface font-medium text-xs hover:bg-surface-container/80 transition-colors border border-outline-variant"
          >
